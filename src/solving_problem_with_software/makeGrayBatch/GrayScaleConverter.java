 ...
 */
package solving_problem_with_software.makeGrayBatch;
...
public class GrayScaleConverter {
	...
	public void selectAndConvertAndSave() {
		...
		for (File f : dr.selectedFiles()) {
			...
			grayImage.setFileName("src/solving_problem_with_software/makeGrayBatch/grayImages/gray-" + inImage.getFileName());
			grayImage.save();
...
gray.draw();
	...
	public static void main(String[] args) {
		...
		converter.selectAndConvertAndSave();
	}
}
