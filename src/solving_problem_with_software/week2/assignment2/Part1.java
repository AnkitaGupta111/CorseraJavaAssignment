...
public class Part1 {
    ...
    static void testFindStopCodon() {
        ...
        System.out.println(findStopCodon("abcATGdefTAA", 3, "TAA"));

        System.out.println("abcATGdefgTGA");
        System.out.println(findStopCodon("abcATGdefgTGA", 3, "TGA"));

        System.out.println("abcATGdefgTAAhiTAG");
        System.out.println(findStopCodon("abcATGdefgTAAhiTAG", 3, "TAG"));
    }
